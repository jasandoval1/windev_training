...
//
// Build
//  cl /EHsc /nologo /std:c++17 /W4 test.cpp intraprocess_queue.cpp
...
constexpr const auto QUEUE_CAPACITY = 1024;
constexpr const auto N_THREADS      = 10;
constexpr const auto OPS_PER_THREAD = 10000;
